...
#region Settings
        ...
        [DefaultValue(false)]
        public bool CrunchyrollRememberLogin = false;

        [DefaultValue(false)]
        public bool UseCrunchyrollService = false;
...
#region Properties
    ...
    #region AniList
        ...
        public string Youtube_BaseURL
        {
            get { return "https://www.youtube.com/embed/"; }
        }
    #endregion AniList

    #region Crunchyroll
        public string Crunchyroll_BaseUrl
        {
            get { return "https://api.crunchyroll.com/"; }
        }

        public int Crunchyroll_ApiVersion
        {
            get { return 0; }
        }
    #endregion Crunchyroll
